"""
Scraper for Open Data Uni Halle - University of Halle Open Data Repository.
"""
import requests
...
class OpenDataHalleScraper(BaseScraper):
    """Scraper for Open Data Uni Halle."""
    
    def __init__(self, config_path: str = "config/qda_extensions.json"):
        """
        Initialize Open Data Halle scraper.
        
        Args:
            config_path: Path to QDA extensions config
        """
        super().__init__(config_path)
        self.base_url = "https://opendata.uni-halle.de"
    ...
    def search(
        ...
        **kwargs
        ...
        """
        Search Open Data Halle for qualitative data.
        ...
        for search_term in search_terms:
            ...
            print(f"Searching Open Data Halle for: '{search_term}'...")
            ...
            while total_fetched < max_results:
                try:
                    ...
                    datasets = soup.find_all('div', class_='dataset-item') or soup.find_all('article', class_='dataset')
                    
                    if not datasets:
                        # Try alternative selectors
                        datasets = soup.find_all('div', class_='search-result') or soup.find_all('li', class_='dataset')
                    ...
                    print(f"Error fetching from Open Data Halle ({search_term}): {e}")
                    break
    ...
    def _extract_dataset_metadata(self, dataset_element) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return self.normalize_metadata({
                ...
                'source_repository': 'Open Data Uni Halle',
